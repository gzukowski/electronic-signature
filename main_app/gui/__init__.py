...
This module provides graphical user interface (GUI) components for the main application of the electronic signature project. It includes classes and methods for signing and verifying PDF files, as well as handling the signing and verification processes in separate threads.
